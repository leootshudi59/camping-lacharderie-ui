    ...
    <div className="w-full">
      <div className="flex flex-col sm:flex-row items-center justify-between mb-4 gap-2">
        ...
        <button
          ...
          className={`px-4 py-2 bg-white text-green-700 border border-green-200 rounded-lg text-sm font-medium shadow-sm hover:bg-green-50 transition ${filterToday ? '!bg-green-600 !text-white !border-green-600 hover:!bg-green-700' : ''
            }`}
        >
      ...
      {filteredOrders.length === 0 && (
        <div className="w-full py-10 flex justify-center text-sm text-gray-500">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {filteredOrders.map((order) => (
                  <tr key={order.order_id} className="hover:bg-green-50 transition">
                    ...
                    <td className="px-4 py-3">{order.booking_name || <span className="italic text-gray-400">–</span>}</td>
                ...
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <h3 className="text-lg font-bold text-gray-800">
                      {order.booking_name || <span className="italic text-gray-400">–</span>}
                    </h3>
                  </div>
